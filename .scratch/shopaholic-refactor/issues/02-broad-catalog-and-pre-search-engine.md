# 02 — 前置全品类广度探索与全价格带扫描引擎 (Broad Catalog & Full-Spectrum Pre-Search)

**What to build:** 在系统检索规程中确立 Turn 1 提问前的前置全谱系广度探索机制，严禁在首轮检索中过早按用户预算做窄化过滤，全面检索品类强制标准、科学物理原理、硬核技术社区（Chiphell/酷安/无忌）讨论与全价格带代表产品（10~15 款宽池），为后续精准提问与深度挖掘建立扎实的行业技术基准。
