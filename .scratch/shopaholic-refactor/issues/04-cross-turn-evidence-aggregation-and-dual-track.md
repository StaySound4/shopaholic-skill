# 04 — 跨轮次深度证据聚合与双轨决策矩阵 (Cross-Turn Evidence Aggregation & Dual-Track Matrix)

**What to build:** 在系统技能入口与证据协议中确立 Stage 3 跨轮次证据全量融合机制，针对 Turn 1 + Turn 2 的候选池进行深度拆解实测核验（L1+L2）、客诉排雷与软广脱水，输出结合一手/二手偏好的 A/B 双轨决策报告。
