...
**What to build:** Represent partial, blocked, and live-source-unavailable outcomes so the system does not silently downgrade authority or fabricate verification.
...
- [ ] Critical unavailable source can block conclusion.
- [ ] Partial evidence lowers grade with explicit gap.
- [ ] Blocked/partial state is observable.
- [ ] Alternative source substitution is disclosed and cannot preserve unjustified confidence.
