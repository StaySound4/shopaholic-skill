...
**What to build:** Compute machine-checkable evaluation metrics from actual run artifacts and case assertions, including constraint, identity, price, budget, round count, and deterministic math outcomes.

**Blocked by:** 02, 04, 08, 18, 25

**Status:** ready-for-agent

## Acceptance criteria

- [ ] Scorer has no preassigned condition quality numbers.
- [ ] Per-assertion evidence includes run/case ID.
- [ ] Known mutation fixtures are detected.
- [ ] Replicates aggregate without overwriting raw runs.
- [ ] Not-adjudicable is distinct from pass.

## Verification procedure

Run scorer on hand-constructed pass/fail fixtures; intentionally corrupt a sensitivity and hard-constraint result and require failure. Adversarial: an unknown gold field must not be scored as wrong.
