# 18 — Define strict current, cross-sectional, and historical price semantics

**What to build:** Make every price claim carry identity, region, seller/channel, observation time, currency, and conditions, and distinguish same-day offer spread from time-series history.
...
- [ ] Current reference price has observation semantics.
- [ ] Historical/common range needs time-separated observations or credible history.
- [ ] Same-day multiple sellers are labeled cross-sectional offers, not historical.
- [ ] Promotion requirements are not silently dropped.

## Verification procedure

Pass: 90-day observations permit historical range; same-day three-store prices do not. Adversarial: coupon/finance/trade-in conditional price cannot be presented as unconditional cash price.
